...
export const Typography: Record<string, FC<TypepogragyProps>> = {
  H1: ({ children, className }) => (
    <h1 className={clsx(TYPEPOGRAFY_CLASSES.H1, HEADING_CLASSES, className)}>
      {children}
    </h1>
  ),
  H2: ({ children, className }) => (
    <h2 className={clsx(TYPEPOGRAFY_CLASSES.H2, HEADING_CLASSES, className)}>
      {children}
    </h2>
  ),
  H3: ({ children, className }) => (
    <h3 className={clsx(TYPEPOGRAFY_CLASSES.H3, HEADING_CLASSES, className)}>
      {children}
    </h3>
  ),
  H4: ({ children, className }) => (
    <h4 className={clsx(TYPEPOGRAFY_CLASSES.H4, HEADING_CLASSES, className)}>
      {children}
    </h4>
  ),
  H5: ({ children, className }) => (
    <h5 className={clsx(TYPEPOGRAFY_CLASSES.H5, HEADING_CLASSES, className)}>
      {children}
    </h5>
  ),
  H6: ({ children, className }) => (
    <h6 className={clsx(TYPEPOGRAFY_CLASSES.H6, HEADING_CLASSES, className)}>
      {children}
    </h6>
  ),
